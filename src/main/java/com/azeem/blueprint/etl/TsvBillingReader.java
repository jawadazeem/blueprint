...
/**
 * Reads billing data from a tab-separated values (TSV) file and returns raw rows as string arrays.
 *
 * <p>This reader behaves identically to {@link CsvBillingReader} but uses tab-delimited input
 * instead of commas.
 *
 * <p>The class exists to isolate file format differences and avoid conditional parsing logic.
 *
 * <p>All data is returned in raw string form and must be transformed by a downstream assembler.
 *
 * <h3>Design Notes</h3>
 *
 * <ul>
 *   <li>Format-specific reader implementation
 *   <li>No domain awareness
 *   <li>Fail-fast on malformed input
 * </ul>
 */
