...
public class AlarmController {
  ...
  public List<Alarm> getAccountBudgetAlarm(@BillingPeriod @PathVariable String billingPeriod) {
    log.info(
        "GET /alarms/account/{} called to retrieve if the account has exceeded its total budget.",
        billingPeriod);
