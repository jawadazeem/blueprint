 ...
 *
 * Verifies aggregation behavior, edge cases (empty input), and grouping semantics.
 */
public class SummaryBuilderTest {
    ...
    void build_happyPath_producesCorrectSummary() {
        ...
        records.add(new BillingRecord("Acme", "E1", "Engineering", "555-0001", "2026-01", 100, 1.5, 10, 45.50));
        records.add(new BillingRecord("Beta", "E2", "Sales", "555-0002", "2026-01", 50, 0.5, 5, 10.00));
        records.add(new BillingRecord("Acme", "E3", "Engineering", "555-0003", "2026-01", 10, 0.1, 1, 5.25));
        ...
        assertEquals(60.75, summary.getTotalCharges(), 1e-9, "totalCharges should sum all charges and round to 2 decimals");
    ...
    void build_emptyList_returnsZeroedSummary() {
        ...
        assertNull(summary.getHighestChargeRecord(), "highestChargeRecord should be null for empty input");
    }
