 ...
 *
 * These tests use in-memory streams to avoid filesystem dependencies and
 * exercise header skipping, row parsing, and EOF behavior.
 */
public class CsvBillingReaderTest {
    ...
    void parseNextRow_withHeader_skipsHeaderAndReturnsRows() throws Exception {
        String csv = "accountName,employeeId,department\n" +
                "Acme,E1,Engineering\n" +
                "Beta,E2,Sales\n";
